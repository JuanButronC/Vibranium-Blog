...
function getCientificos(cientificos){
    $.ajax({
        type: "GET",
        url: "articulos/funciones/getConcidenciasCientifico.php",
...
function getDecada(decada){
    $.ajax({
        type: "GET",
        url: "articulos/funciones/getCoincidenciasDecada.php",
        data:{decada:decada},
        dataType: "html",
        success: function (response) {
                $("#div-articulos").html(response);    
...
function getSiglo(siglo){
    $.ajax({
        type: "GET",
        url: "articulos/funciones/getCoincidenciasSiglo.php",
        data:{siglo:siglo},
        dataType: "html",
        success: function (response) {
                $("#div-articulos").html(response);   
...
function getAutor(id,autor){
    $.ajax({
        type: "GET",
        url: "articulos/funciones/getConcidenciasAutor.php",
        data:{idAutor:id},
        dataType: "html",
        success: function (response) {
                $("#div-articulos").html(response);
...
function getArea(id,area){
    $.ajax({
        type: "GET",
        url: "articulos/funciones/getConcidenciasArea.php",
        data:{idArea:id},
        dataType: "html",
        success: function (response) {
                $("#div-articulos").html(response);  
...
function getFiltros(inputs){
    $.ajax({
        type: "GET",
        url: "articulos/funciones/getConcidenciasFiltros.php",
        data:inputs,
        dataType: "html",
        success: function (response) {
                $("#div-articulos").html(response);  
...
function getCoincidencias(){
    $.ajax({
        type: "GET",
        url: "articulos/funciones/getConcidencias.php",
...
function getArticulos(){
    $.ajax({
        type: "GET",
        url: "articulos/funciones/getArticulos.php",
        dataType: "html",
        success: function (response) {
                hide_search_heading();
                $("#div-articulos").html(response); 
...
function getAreas(){
    $.ajax({
        type: "GET",
        url: "articulos/funciones/getAreas.php",
        dataType: "html",
        success: function (response) {
...
function getAutores(){
    $.ajax({
        type: "GET",
        url: "articulos/funciones/getAutoresDestacados.php",
        dataType: "html",
        success: function (response) {
